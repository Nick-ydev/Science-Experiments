...
player1_result = result_calc(player1_choice,dealer_choice,player1_bet,player1_pot,snake_eyes)
player2_result = result_calc(player2_choice,dealer_choice,player2_bet,player2_pot,snake_eyes)
